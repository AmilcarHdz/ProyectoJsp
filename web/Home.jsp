...
<!--                        <li>
                      ...
                      <li>
                        ...
                        <img src="assets/img/faces/3.png" style="max-width: 500; max-height: 100px" alt="" class="logotipo"/><!--Imagen que sive como logotipo-->
                        </center>
                    </ul>
 ...
 if (sesion.getAttribute("user")!=null && sesion.getAttribute("nivel")!=null) {
         ...
         out.print("<a href='index.jsp?cerrar=true'><button class='btn btn-Dark' style='color: black' >Cerrar Sesion</button></a>");
     }
 else{
